...
const char* g_app_config[] = { "1:/pixilang_config.ini", "2:/pixilang_config.ini", 0 };
...
" -ncl          disable logging to console\n"
" -nfl          disable logging to file\n"
...
" -i <dir>      add the directory to the search path for include files\n"
